--- 
title: "`r paste('National Wildlife Refuge Visitor Survey:  Individual Refuge Results for ', params$RefugeName)`"
...
knitr::include_graphics(paste('refuge-info', params$RefugeName, 'cover.JPG', sep = '/'), dpi = 5)
```
